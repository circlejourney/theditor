...
<html lang="en">
    <head>
        ...
        <script src="script.js?<?php echo $lastUpdate ?>" type="text/javascript"></script>
        <link rel="stylesheet" href="style.css?<?php echo $lastUpdate ?>">
    ...
    <div id="info" class="d-none">
        <div class="card">
            ...
            <div id="info-main" class="card-block text-center">
                ...
                <a href="#" class="btn btn-primary" onclick="showInfo()">Got it!</a>
                <a href="#" class="btn btn-secondary" data-toggle="collapse" data-target="#changelog">Changelog</a>
                <a href="#" class="btn btn-secondary" data-toggle="collapse" data-target="#issues">Known issues</a>
                <a href="#" class="btn btn-secondary" data-toggle="collapse" data-target="#versions">Versions</a>
                <p></p>
                <div id="accordion">
    ...
    <div id="main">
        <iframe src="frame.html?<?php echo $lastUpdate ?>" id="frame" class="d-flex">
        </iframe>
