...
$(window).on("load", function(){
    ...
    $.get("known-issues.html?20210103", (data) => {
        $("#issues-text").html(data);
    });
    
    $.get("changelog.html?20210103", (data) => {
...
function resizeElements() {
    ...
    debug_log($(editor.container).height());
}
...
function dragHandler(e) {
    ...
    debug_log("#editor height: "+$("#editor").height());
    debug_log("#fields height: "+$("#fields").height());
    debug_log("#html-editor height: "+$("#html-editor").height());
    debug_log($(editor.container).height());
}
