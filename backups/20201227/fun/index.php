...
<html>
    <head>
        ...
        <script>
            ...
            function getRandom() {
                ...
                $("#random-char-link").attr("href", "https://toyhou.se"+char.href);
            }
            ...
            function getPop() {
                ...
                $("#popular-char-link").attr("href", "https://toyhou.se"+charlist[0].href);
            }
        </script>
    ...
    <body class="switch d-none">
        <div class="container-fluid">
            <div class="text-center">
                <h1>Toyhouse tools</h1>
                <p>Pick a random character from a user, find a user's most popular character, etc. A work in progress. Note that only characters that are viewable by guests will show up.</p>
