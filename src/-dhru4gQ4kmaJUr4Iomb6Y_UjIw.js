;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="e9903914104a686c53617e4ca183743e";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["sB-kvCR8FsPv"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["sB-kvCR8FsPv"].options={"id":"UA-56561808-1","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['sB-kvCR8FsPv'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['sB-kvCR8FsPv'].URLPatterns)){(function(){var options=CloudflareApps.installs['sB-kvCR8FsPv'].options
